...
_ as (..)
`).toString();
assert(s === String.raw`VersionDirective "fus ${$api.currentVersion}", NormalToken "dotDot_573300145710716007", Colon, NormalToken "_", Semicolon, NormalToken "_", As, NormalToken "dotDot_573300145710716007"`);
}); // ============================================================
