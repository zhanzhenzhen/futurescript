    ...
    rawCompile() {
        ...
        this.body.value.forEach(m => {
            if (m.x.static && m.x.name === null) {
                ...
                m.y instanceof $expressionFunction.ArrowFunctionExpression ||
                m.y instanceof $expressionFunction.DiamondFunctionExpression ||
                m.y instanceof $expressionFunction.DashFunctionExpression
            ) {
