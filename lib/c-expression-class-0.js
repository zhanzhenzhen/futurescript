...
face.ClassExpression = class extends face.Expression {
    ...
    rawCompile() {
        ...
        this.body.value.forEach(m => {
            if (m.x.static && m.x.name === null) {
                ...
                m.y instanceof face.ArrowFunctionExpression ||
                m.y instanceof face.DiamondFunctionExpression ||
                m.y instanceof face.DashFunctionExpression
            ) {
