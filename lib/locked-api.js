...
let bundlerLookup = function() {
    require("./c-v0.1.0/main.js");
    require("./c-v0.2.0/main.js");
    require("./c-v0.3.0/main.js");
    require("./c-v0.4.0/main.js");
    require("./c-v0.5.0/main.js");
};
...
`OutputLevel.exports`. What's style? See `codeStyles` function.
...
`styles` will be absent if `generatesStyles` is false.
...
/*
This function categorizes code parts into styles. Useful in syntax highlighting.
...
*/
export let codeStyles = function(code) {
    return generateOutput({code: code, level: OutputLevel.exports, generatesStyles: true}).styles;
};
