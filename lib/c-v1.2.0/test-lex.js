...
[(a, b)] -> a + b
`).toString();
assert(s === String.raw`VersionDirective "fus ${$api.currentVersion}", NormalLeftParenthesis, NormalToken "a", Comma, NormalToken "b", Spread, NormalRightParenthesis, ArrowFunction, NormalToken "b", Semicolon, NormalLeftBracket, NormalLeftParenthesis, NormalToken "a", Comma, NormalToken "b", NormalRightParenthesis, NormalRightBracket, ArrowFunction, NormalToken "a", Plus, NormalToken "b"`);
}); // ============================================================
