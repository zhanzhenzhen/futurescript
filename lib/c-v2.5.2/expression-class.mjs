...
export class ClassExpression extends $base.Expression {
    ...
    bareCompile() {
        ...
        let part4 =
            ...
            "" :
            new J([
                (treeStaticConstructor.y.getAsync() ? "await " : ""),
                treeStaticConstructor.y.compile(),
                ".call(" + classVar + ");"
            ]);
        return $node.applyWrapperFunction(
            new J([part1, part2, part3, part4, $node.applyReturn(classVar, this)]),
            this,
            (treeStaticConstructor === null ? null : treeStaticConstructor.y)
        );
    }
