...
export class AssignStatement extends Statement {
    ...
    compile() {
        ...
        if (this.getHasSelf() || firstAssignee.ifvoid || firstAssignee.ifnull) {
            ...
            if (firstAssignee.ifvoid) {
                body = new J(["if (", $node.compileAssignee(firstAssignee), "===undefined){", jb, ";}"]);
            }
