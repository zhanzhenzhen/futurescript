...
export class Block extends $nodeBase.MappableNode {
    ...
    compile() {
        ...
        if (this instanceof RootBlock) {
            ...
            let libOkDot = this.predefinedLib.okDot ?
                "var okDot_" + antiConflictString +
`=function(a, b) {
    return ok_${antiConflictString}(a) ? a[b] : undefined;
};`
                : "";
...
`=function(pattern, flags) {
    ...
    return new RegExp(s, flags);
                ...
                : "";
            let libAsyncToGenerator = this.predefinedLib.asyncToGenerator ?
                "var asyncToGenerator_" + antiConflictString +
`=function(fn) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        step("next");
                ...
                : "";
            let libChainedCompare = this.predefinedLib.chainedCompare ?
                "var chainedCompare_" + antiConflictString +
`=function(a, b, c, d, e) {
    ...
    return calc(a, b, c) && calc(c, d, e);
            ...
            return new J([
                ...
                libMod, libOk, libOkDot, libIfvoid, libIfnull, libDotDotCalc, libFormattedRegex,
                libAsyncToGenerator, libChainedCompare,
            ...
            if (this.getParent() instanceof $node.FunctionExpression && this.getParent().getAsync()) {
                ...
                return new J([`(asyncToGenerator_${antiConflictString}.call(this,function*(){`, jb, "}))"]);
            }
            else {
...
export class RootBlock extends ScopeBlock {
    constructor(lex, outputCodeReadability = 0) {
        ...
        this.value.forEach(statement => {
            if (statement instanceof $node.ImportStatement && statement.batchall) {
                ...
                try {
                    allVariableNames = $lockedApi.fileExports(pathToRead);
                } catch (ex) {}
                if (allVariableNames === null) {
                    try {
                        allVariableNames = $lockedApi.fileExports(pathToRead + ".fus");
                    } catch (ex) {}
                }
                if (allVariableNames === null) {
