// Generally, a ruler can be a token type, an array of token types, a validating function,
// a pair, or a quantifier. But many checkers have stricter restrictions.
...
export class Pattern {
    ...
    */
    ...
    // `ruler` can only be a token type or an array of token types. Note: For performance,
    // it won't check that.
