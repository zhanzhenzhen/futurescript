...
export class Pattern {
    ...
    If `rulers` is [LeftChevron], then it will match.
    If `rulers` is [LeftChevron, NormalToken, RightChevron], then it won't match.
    If `rulers` is [LeftChevron, RightChevron], then it won't match.
    ...
    */
    static matchPattern(rulers, lexPart, leftToRight) {
        ...
        while (
            ...
            if (
                ruler !== previousRuler &&
                previousRuler instanceof Quantifier &&
                ruler instanceof Quantifier
            ) {
                throw new Error();
            }
