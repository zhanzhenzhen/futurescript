...
// Just one feature: Add the `oppositeIndex` property.
// They will later be used by parser to scan fast.
// If it isn't an enclosing token, then this property will be absent.
