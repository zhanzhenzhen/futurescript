...
let r = $pattern.Pattern.searchOne(
    $lex.Colon,
    lex.part(1),
    true
);
...
let r = $pattern.Pattern.matchPattern(
...
assert(
    Array.isArray(r) && r.length === 1 &&
    r[0] instanceof Object && r[0].startIndex === 1 && r[0].endIndex === 8
);
}); // ============================================================
...
let r = $pattern.Pattern.matchPatternCapture(
    [$lex.Pause],
    lex.part(1),
    true,
    []
