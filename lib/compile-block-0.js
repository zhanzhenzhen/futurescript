    ...
    constructor(lexPart) {
        ...
        for (let i = startIndex; i <= endIndex; i++) {
            if (lex.at(i) instanceof $lex.LeftChevron) {
                ...
                this.value.push($statement.Statement.build(lex.part(statementStartIndex, i - 1), this));
                statementStartIndex = i + 1;
            }
        }
        this.value.push($statement.Statement.build(lex.part(statementStartIndex, endIndex), this));
    }
...
export class RootBlock extends Block {
    constructor(lex) {
        ...
        let makeLinks = (thing, parent) => {
            ...
            else if (thing instanceof $node.NameValue) {
