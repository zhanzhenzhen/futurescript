...
export class RemExpression extends $expressionBase.BinaryExpression {
    rawCompile() {
        return [this.x.compile(), "%", this.y.compile()];
    }
}
...
export class ModExpression extends $expressionBase.BinaryExpression {
    rawCompile() {
...
export class PowerExpression extends $expressionBase.BinaryExpression {
    rawCompile() {
