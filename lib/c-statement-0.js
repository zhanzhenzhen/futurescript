    ...
    static patternsAndCaptures() {
        return [
            [[$lex.NormalToken, $lex.Colon, $lex.Import,
                $lex.InlineNormalString, $pattern.CallParenthesisPair], [0, [3, 4], null]],
            [[$lex.NormalToken, $lex.Colon, $lex.Import,
                $lex.InlineNormalString, $pattern.CallParenthesisPair,
                (m => m instanceof $lex.NormalToken && m.value === "all")], [0, [3, 4], 5]],
            [[$lex.NormalBracePair, $lex.Colon, $lex.Import,
                $lex.InlineNormalString, $pattern.CallParenthesisPair], [0, [3, 4], null]],
            [[$lex.NormalBracePair, $lex.Colon, $lex.Import,
                $lex.InlineNormalString, $pattern.CallParenthesisPair,
                (m => m instanceof $lex.NormalToken && m.value === "all")], [0, [3, 4], 5]]
