...
let Expression = pool.Expression = class extends $node.MappableNode {
    static leftToRight() {
...
let AtomExpression = pool.AtomExpression = class extends Expression {
    constructor(value) {
        super();
        this.value = value;
    }
...
pool.BinaryExpression = class extends Expression {
    constructor(x, y) {
        super();
        this.x = x;
        this.y = y;
...
pool.UnaryExpression = class extends Expression {
    constructor(x) {
        super();
        this.x = x;
    }
...
pool.VariableExpression = class extends AtomExpression {
    rawCompile() {
        return this.value;
    }
}

pool.NumberExpression = class extends AtomExpression {
    rawCompile() {
        return this.value;
    }
}

pool.BooleanExpression = class extends AtomExpression {
    rawCompile() {
        return this.value;
    }
}

pool.NullExpression = class extends AtomExpression {
    rawCompile() {
        return "null";
    }
}

pool.VoidExpression = class extends AtomExpression {
    rawCompile() {
        return "undefined";
    }
}

pool.ArgExpression = class extends AtomExpression {
    rawCompile() {
...
pool.FunExpression = class extends AtomExpression {
    rawCompile() {
        return "fun_" + $block.antiConflictString;
    }
}

pool.SelfExpression = class extends AtomExpression {
    rawCompile() {
...
pool.MeExpression = class extends AtomExpression {
    rawCompile() {
        return "this";
    }
}

pool.ClassMeExpression = class extends AtomExpression {
    rawCompile() {
...
pool.StringExpression = class extends AtomExpression {
    rawCompile() {
...
pool.PostQuoteExpression = class extends AtomExpression {}

// This refers to `InlineNormalString` token.
pool.InlineNormalStringExpression = class extends AtomExpression {}

pool.FormattedNormalStringExpression = class extends AtomExpression {}

pool.InlineVerbatimStringExpression = class extends AtomExpression {}

pool.FormattedVerbatimStringExpression = class extends AtomExpression {}

pool.InlineRegexExpression = class extends AtomExpression {}

pool.FormattedRegexExpression = class extends AtomExpression {}

pool.InlineJsExpression = class extends AtomExpression {}

pool.FormattedJsExpression = class extends AtomExpression {}

pool.ParseSingleTokenError = class extends $lex.SyntaxError {
    constructor(lexPart) {
        super(lexPart, "The single token can't be parsed as expression.");
    }
}

pool.NoPatternMatchError = class extends $lex.SyntaxError {
    constructor(lexPart) {
