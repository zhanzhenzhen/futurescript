...
{not a + 1 or b |> c.d}
`).toString();
assert(s === String.raw`VersionDirective "fus ${$api.currentVersion}", NormalLeftBrace, NormalToken "not", Colon, NormalToken "a", Plus, Num "1", Comma, NormalToken "or", Colon, NormalToken "b", Pipe, NormalToken "c", Dot, NormalToken "d", NormalRightBrace`);
}); // ============================================================
