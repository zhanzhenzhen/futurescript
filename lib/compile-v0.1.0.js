...
let MinusExpression = class MinusExpression extends Expression {
    constructor(x, y) {
        super();
        this.x = x;
        this.y = y;
    ...
    static applySearchResult(found, f) {
        return new MinusExpression(f(found.value.x), f(found.value.y));
    }
};

let TimesExpression = class TimesExpression extends Expression {
    constructor(x, y) {
        super();
        this.x = x;
        this.y = y;
    ...
    static applySearchResult(found, f) {
        return new TimesExpression(f(found.value.x), f(found.value.y));
    }
};

let OverExpression = class OverExpression extends Expression {
    constructor(x, y) {
        super();
        this.x = x;
        this.y = y;
    ...
    static applySearchResult(found, f) {
        return new OverExpression(f(found.value.x), f(found.value.y));
    }
};
...
let GreaterThanExpression = class GreaterThanExpression extends Expression {
    ...
    static applySearchResult(found, f) {
        return new GreaterThanExpression(f(found.value.x), f(found.value.y));
    }
};
