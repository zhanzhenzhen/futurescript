...
(3) The only node module that non-node modules can import is "node", which contains all of its parent's exports. Don't confuse the "node.mjs" file with the famous Node.js platform. It's not about that.
