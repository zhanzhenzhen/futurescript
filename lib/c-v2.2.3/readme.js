...
6. There may be a "ref" variable (the actual name can be another) in the compiled code. If the compiler doesn't follow the rule of how to use it, this variable will be messed up - that will cause bugs in the compiler. The rule is: for a compiled expression, the occurences of this variable must be consecutive (i.e. there can't be other compiled expressions in-between).
