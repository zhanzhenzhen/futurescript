...
face.ArrowFunctionExpression = class extends face.Expression {
    ...
    rawCompile() {
        ...
        if (
            ...
            this.getParent().getParent().getParent() instanceof face.ClassExpression
        ) {
            ...
            if (this.getParent(face.ClassExpression) === null) {
                return [
                    "function " + name + "(", variables, "){",
                    voidDefaults, nullDefaults,
                    "return ", this.body.compile(), ";}"
...
face.DiamondFunctionExpression = class extends face.Expression {
    constructor(body) {
        super();
        this.body = body;
    }
...
face.DashFunctionExpression = class extends face.Expression {
    constructor(body) {
        super();
        this.body = body;
    }
...
face.ParenthesisCallExpression = class extends face.Expression {
    ...
    rawCompile() {
        ...
        if (this.callee instanceof face.OkVariantExpression) {
...
face.BracketCallExpression = class extends face.Expression {
    static patternsAndCaptures() {
        return [
    ...
    static applyMatch(match, lex) {
        return new face.ParenthesisCallExpression(
            this.build(lex.part(match[0])),
            new $node.Arr([
...
face.BraceCallExpression = class extends face.Expression {
    static patternsAndCaptures() {
        return [
...
face.SpaceCallExpression = class extends face.Expression {
...
face.PseudoCallExpression = class extends face.Expression {
    constructor(callee, args) {
        super();
        this.callee = callee;
        this.arguments = args;
    ...
    rawCompile() {
        if (this.callee instanceof face.InlineNormalStringExpression) {
            return this.arguments.value[0].compile();
        }
        else if (this.callee instanceof face.FormattedNormalStringExpression) {
            return this.arguments.value[0].compile();
        }
        else if (this.callee instanceof face.InlineVerbatimStringExpression) {
            return this.arguments.value[0].compile();
        }
        else if (this.callee instanceof face.FormattedVerbatimStringExpression) {
            return this.arguments.value[0].compile();
        }
        else if (this.callee instanceof face.InlineRegexExpression) {
        ...
        else if (this.callee instanceof face.FormattedRegexExpression) {
        ...
        else if (this.callee instanceof face.InlineJsExpression) {
            return this.arguments.value[0].value;
        }
        else if (this.callee instanceof face.FormattedJsExpression) {
            return this.arguments.value[0].value;
        }
        else {
...
face.DoExpression = class extends face.Expression {
    constructor(f) {
        super();
        this.function = f;
    }
