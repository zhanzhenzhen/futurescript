    ...
    static patternsAndCaptures() {
        return [
            [[$pattern.tokensExcept([
                $lex.InlineNormalString,
                $lex.FormattedNormalString,
                $lex.InlineVerbatimString,
                $lex.FormattedVerbatimString,
                $lex.InlineRegex,
                $lex.FormattedRegex,
                $lex.InlineJs,
                $lex.FormattedJs
            ]), $pattern.CallParenthesisPair], [0, 1]]
        ];
    }
...
export class TinyCallExpression extends $expressionBase.Expression {
    constructor(callee, args) {
        super();
        this.callee = callee;
        this.arguments = args;
    ...
    static patternsAndCaptures() {
        return [
            [[$lex.InlineNormalString, $pattern.CallParenthesisPair], [0, 1]],
            [[$lex.FormattedNormalString, $pattern.CallParenthesisPair], [0, 1]],
            [[$lex.InlineVerbatimString, $pattern.CallParenthesisPair], [0, 1]],
            [[$lex.FormattedVerbatimString, $pattern.CallParenthesisPair], [0, 1]],
            [[$lex.InlineRegex, $pattern.CallParenthesisPair], [0, 1]],
            [[$lex.FormattedRegex, $pattern.CallParenthesisPair], [0, 1]],
            [[$lex.InlineJs, $pattern.CallParenthesisPair], [0, 1]],
            [[$lex.FormattedJs, $pattern.CallParenthesisPair], [0, 1]]
        ];
    }
