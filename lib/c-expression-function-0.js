...
pool.ArrowFunctionExpression = class extends pool.Expression {
...
pool.DiamondFunctionExpression = class extends pool.Expression {
    constructor(body) {
        super();
        this.body = body;
    }
...
pool.DashFunctionExpression = class extends pool.Expression {
    constructor(body) {
        super();
        this.body = body;
    }
...
pool.ParenthesisCallExpression = class extends pool.Expression {
...
pool.BracketCallExpression = class extends pool.Expression {
    static patternsAndCaptures() {
        return [
...
pool.BraceCallExpression = class extends pool.Expression {
    static patternsAndCaptures() {
        return [
...
pool.SpaceCallExpression = class extends pool.Expression {
...
pool.PseudoCallExpression = class extends pool.Expression {
    constructor(callee, args) {
        super();
        this.callee = callee;
        this.arguments = args;
...
pool.DoExpression = class extends pool.Expression {
    constructor(f) {
        super();
        this.function = f;
    }
