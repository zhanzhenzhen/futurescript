...
export class ArrowFunctionExpression extends $node.Expression {
...
export class DiamondFunctionExpression extends $node.Expression {
    constructor(body) {
        super();
        this.body = body;
    }
...
export class DashFunctionExpression extends $node.Expression {
    constructor(body) {
        super();
        this.body = body;
    }
...
export class ParenthesisCallExpression extends $node.Expression {
...
export class BracketCallExpression extends $node.Expression {
    static patternsAndCaptures() {
        return [
...
export class BraceCallExpression extends $node.Expression {
    static patternsAndCaptures() {
        return [
...
export class SpaceCallExpression extends $node.Expression {
...
export class PseudoCallExpression extends $node.Expression {
...
export class DoExpression extends $node.Expression {
    constructor(f) {
        super();
        this.function = f;
    }
