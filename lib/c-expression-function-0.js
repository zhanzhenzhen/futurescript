...
hub.ArrowFunctionExpression = class extends hub.Expression {
    ...
    rawCompile() {
        ...
        if (
            ...
            this.getParent().getParent().getParent() instanceof hub.ClassExpression
        ) {
            ...
            if (this.getParent(hub.ClassExpression) === null) {
                return [
                    "function " + name + "(", variables, "){",
                    voidDefaults, nullDefaults,
                    "return ", this.body.compile(), ";}"
...
hub.DiamondFunctionExpression = class extends hub.Expression {
    constructor(body) {
        super();
        this.body = body;
    }
...
hub.DashFunctionExpression = class extends hub.Expression {
    constructor(body) {
        super();
        this.body = body;
    }
...
hub.ParenthesisCallExpression = class extends hub.Expression {
    ...
    rawCompile() {
        ...
        if (this.callee instanceof hub.OkVariantExpression) {
...
hub.BracketCallExpression = class extends hub.Expression {
    static patternsAndCaptures() {
        return [
    ...
    static applyMatch(match, lex) {
        return new hub.ParenthesisCallExpression(
            this.build(lex.part(match[0])),
            new $node.Arr([
...
hub.BraceCallExpression = class extends hub.Expression {
    static patternsAndCaptures() {
        return [
...
hub.SpaceCallExpression = class extends hub.Expression {
...
hub.PseudoCallExpression = class extends hub.Expression {
    constructor(callee, args) {
        super();
        this.callee = callee;
        this.arguments = args;
    ...
    rawCompile() {
        if (this.callee instanceof hub.InlineNormalStringExpression) {
            return this.arguments.value[0].compile();
        }
        else if (this.callee instanceof hub.FormattedNormalStringExpression) {
            return this.arguments.value[0].compile();
        }
        else if (this.callee instanceof hub.InlineVerbatimStringExpression) {
            return this.arguments.value[0].compile();
        }
        else if (this.callee instanceof hub.FormattedVerbatimStringExpression) {
            return this.arguments.value[0].compile();
        }
        else if (this.callee instanceof hub.InlineRegexExpression) {
        ...
        else if (this.callee instanceof hub.FormattedRegexExpression) {
        ...
        else if (this.callee instanceof hub.InlineJsExpression) {
            return this.arguments.value[0].value;
        }
        else if (this.callee instanceof hub.FormattedJsExpression) {
            return this.arguments.value[0].value;
        }
        else {
...
hub.DoExpression = class extends hub.Expression {
    constructor(f) {
        super();
        this.function = f;
    }
