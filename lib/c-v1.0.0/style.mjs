...
export let generateStyles = lex => {
    ...
    tokens.forEach((token, index) => {
        // There may already be some extended styles generated while building the tree.
        // But we still need to set the main style.
        token.addStyle(tokenStyle(index, tokens));
