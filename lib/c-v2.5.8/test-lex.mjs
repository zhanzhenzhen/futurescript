...
let lexPart = lex.part().changeTo(3, 4);
...
class
    aaa: <>
        ...
        1 as me.a
`).toString();
assert(s === String.raw`VersionDirective "fus ${$api.currentVersion}", Class, LeftChevron, NormalToken "aaa", Colon, DiamondFunction, LeftChevron, Me, Dot, NormalToken "a", Colon, Num "1", Semicolon, Num "1", As, Me, Dot, NormalToken "a", RightChevron, RightChevron`);
}); // ============================================================
...
345 as true
`).toString();
assert(s === String.raw`VersionDirective "fus ${$api.currentVersion}", Export, NormalToken "abc", As, NormalToken "null", Semicolon, NormalToken "def", ExportAs, NormalToken "false", Semicolon, Num "345", As, True`);
}); // ============================================================
...
e =>
    ...
    e.rawStart[0] === 2 && e.rawStart[1] === 5 &&
    e.rawEnd[0] === 3 && e.rawEnd[1] === 3
);
}); // ============================================================
...
b: x ->
    if x
        ...
        2
`).toString();
assert(s === String.raw`VersionDirective "fus ${$api.currentVersion}", NormalToken "a", Colon, NormalToken "x", ArrowFunction, Match, NormalToken "x", LeftChevron, Num "0", Then, Num "1", Semicolon, Else, Num "2", RightChevron, Semicolon, NormalToken "b", Colon, NormalToken "x", ArrowFunction, LeftChevron, If, NormalToken "x", LeftChevron, Num "1", RightChevron, Else, LeftChevron, Num "2", RightChevron, RightChevron`);
}); // ============================================================
...
e =>
    e instanceof $lex.MatchNoBodyError &&
    e.rawStart[0] === 1 && e.rawStart[1] === 1 &&
    e.rawEnd[0] === 1 && e.rawEnd[1] === 6
);
}); // ============================================================
...
x: 0o7654
`).toString();
assert(s === String.raw`VersionDirective "fus ${$api.currentVersion}", NormalToken "x", Colon, Num "0b1101", Semicolon, NormalToken "x", Colon, Num "0o7654"`);
}); // ============================================================
...
a: b.0x3en+1n
`).toString();
assert(s === String.raw`VersionDirective "fus ${$api.currentVersion}", NormalToken "x", Colon, Num "123456789012345678n", Semicolon, NormalToken "x", Colon, Num "0x3en", Semicolon, NormalToken "a", Colon, NormalToken "b", Dot, NormalLeftParenthesis, Num "1n", NormalRightParenthesis, Semicolon, NormalToken "a", Colon, NormalToken "b", Dot, NormalLeftParenthesis, Num "0x3en", NormalRightParenthesis, Plus, Num "1n"`);
}); // ============================================================
