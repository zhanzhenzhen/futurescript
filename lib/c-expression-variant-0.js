...
export class NormalVariantExpression extends $node.Expression {
...
export class OkVariantExpression extends $node.Expression {
    constructor(x) {
        super();
        this.x = x;
    }
...
export class FunctionVariantExpression extends $node.Expression {
    constructor(x) {
        super();
        this.x = x;
    }
