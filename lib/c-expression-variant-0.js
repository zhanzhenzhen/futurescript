...
pool.NormalVariantExpression = class extends pool.Expression {
...
pool.OkVariantExpression = class extends pool.Expression {
    constructor(x) {
        super();
        this.x = x;
    }
...
pool.FunctionVariantExpression = class extends pool.Expression {
    constructor(x) {
        super();
        this.x = x;
    }
...
pool.VariantNameError = class extends $lex.SyntaxError {
    constructor(lexPart) {
