...
export class DotExpression extends pool.Expression {
    constructor(x, y) {
        super();
        this.x = x;
        this.y = y;
...
export class ObjectExpression extends pool.Expression {
    constructor(value) {
        super();
        this.value = value;
    }
...
export class ArrayExpression extends pool.Expression {
    constructor(value) {
        super();
        this.value = value;
    }
