...
export class DotExpression extends $node.Expression {
    constructor(x, y) {
        super();
        this.x = x;
        this.y = y;
...
export class ObjectExpression extends $node.Expression {
    constructor(value) {
        super();
        this.value = value;
    }
...
export class ArrayExpression extends $node.Expression {
    constructor(value) {
        super();
        this.value = value;
    }
