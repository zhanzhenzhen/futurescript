...
hub.DotExpression = class extends hub.Expression {
    constructor(x, y) {
        super();
        this.x = x;
        this.y = y;
    ...
    rawCompile() {
        let jb = (x, y) => new J(
            y instanceof hub.Expression ?
            [x.compile(), "[", y.compile(), "]"] :
            [x.compile(), ".", y.compile()]
        );
        if (this.x instanceof hub.OkVariantExpression) {
...
hub.ObjectExpression = class extends hub.Expression {
    constructor(value) {
        super();
        this.value = value;
    }
...
hub.ArrayExpression = class extends hub.Expression {
    constructor(value) {
        super();
        this.value = value;
    }
