...
face.DotExpression = class extends face.Expression {
    constructor(x, y) {
        super();
        this.x = x;
        this.y = y;
    ...
    rawCompile() {
        let jb = (x, y) => new J(
            y instanceof face.Expression ?
            [x.compile(), "[", y.compile(), "]"] :
            [x.compile(), ".", y.compile()]
        );
        if (this.x instanceof face.OkVariantExpression) {
...
face.ObjectExpression = class extends face.Expression {
    constructor(value) {
        super();
        this.value = value;
    }
...
face.ArrayExpression = class extends face.Expression {
    constructor(value) {
        super();
        this.value = value;
    }
