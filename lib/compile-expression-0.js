...
export class Expression {
    ...
    static build(lexPart, parentBlock) {
        ...
        let expression = (lexPart, parentBlock) => {
            let lex = lexPart.lex;
            let startIndex = lexPart.startIndex;
            let endIndex = lexPart.endIndex;
                ...
                for (let i = 0; i < this.precedence.length; i++) {
                    ...
                    if (nearest !== null) {
                        ...
                        return nearest.type.applyMatch(
                            nearest.match, expression, lexPart, parentBlock
                        );
                    }
                }
            }
...
export class BinaryExpression extends Expression {
    ...
    static match(lexPart, parentBlock) {
        ...
        let pos = $pattern.Pattern.searchOne(this.sign, lexPart, this.leftToRight());
        if (pos !== null) {
            return [
    ...
    static applyMatch(match, f, lexPart, parentBlock) {
        return new this(
