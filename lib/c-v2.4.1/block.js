    ...
    return new Promise(function(resolve, reject) {
        ...
        step("next");
            ...
            if (this.getParent() instanceof $node.FunctionExpression && this.getParent().getAsync()) {
                ...
                jb = new J([`(asyncToGenerator_${antiConflictString}.call(this,function*(){`, jb, "}))"]);
                if (this.getParent().getHasFun()) {
                    jb = new J([`((()=>{var fun_${antiConflictString}=`, jb, "})())"]);
                }
                return jb;
            }
            else {
                if (this.getParent() instanceof $node.FunctionExpression && this.getParent().getHasFun()) {
                    jb = new J([
                        `var fun_${antiConflictString};(fun_${antiConflictString}=()=>{`,
                        jb,
                        "})();"
                    ]);
                }
