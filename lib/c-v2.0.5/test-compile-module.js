...
test(async () => {
let r = $libApi.generateOutput({code: code`
a: import "./a.js"
`}).targets[0].code;
...
test(async () => {
let r = $libApi.generateOutput({code: code`, node modules
a: import "./a.js"
`}).targets[0].code;
...
`}).targets[0].code;
assert(r === '"use strict";var dotDot_573300145710716007;dotDot_573300145710716007=(function(){var arg_573300145710716007=arguments;return ((()=>{return ({contains:(function(x){return ((()=>{return (true);})());})});})());});export {dotDot_573300145710716007 as dotDot_573300145710716007};');
}); // ============================================================
...
..'export: <> {contains: x -> true}
`}).targets[0].code;
assert(r === '"use strict";var dotDot_573300145710716007;exports.dotDot_573300145710716007=dotDot_573300145710716007=(function(){var arg_573300145710716007=arguments;return ((()=>{return ({contains:(function(x){return ((()=>{return (true);})());})});})());});');
}); // ============================================================
