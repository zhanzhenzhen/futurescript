...
face.AsExpression = class extends face.Expression {
    ...
    rawCompile() {
        ...
        if (this.assignee instanceof $node.DotAssignee) {
            if (this.assignee.y instanceof face.Expression) {
