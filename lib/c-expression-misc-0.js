...
hub.AsExpression = class extends hub.Expression {
    ...
    rawCompile() {
        ...
        if (this.assignee instanceof $node.DotAssignee) {
            if (this.assignee.y instanceof hub.Expression) {
