...
export class AsExpression extends pool.Expression {
...
export class IfvoidExpression extends pool.BinaryExpression {
    rawCompile() {
...
export class IfnullExpression extends pool.BinaryExpression {
    rawCompile() {
