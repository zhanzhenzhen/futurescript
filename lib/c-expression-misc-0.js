...
pool.AsExpression = class extends pool.Expression {
...
pool.IfvoidExpression = class extends pool.BinaryExpression {
    rawCompile() {
...
pool.IfnullExpression = class extends pool.BinaryExpression {
    rawCompile() {
