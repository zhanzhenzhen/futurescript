...
hub.IfExpression = class extends hub.Expression {
...
hub.PostIfExpression = class extends hub.Expression {
    static patternsAndCaptures() {
        return [
...
hub.MatchExpression = class extends hub.Expression {
        ...
        if (this.items.value.length === 0) {
            ...
            let conditionPart = x =>
                $tools.instanceof(this.comparer, [
                    hub.ArrowFunctionExpression,
                    hub.DiamondFunctionExpression,
                    hub.DashFunctionExpression
                ]) ?
