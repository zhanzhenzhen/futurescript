...
export class IfExpression extends pool.Expression {
...
export class PostIfExpression extends pool.Expression {
    static patternsAndCaptures() {
        return [
...
export class MatchExpression extends pool.Expression {
