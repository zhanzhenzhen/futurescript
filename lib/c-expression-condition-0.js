...
export class IfExpression extends $node.Expression {
...
export class PostIfExpression extends $node.Expression {
    static patternsAndCaptures() {
        return [
...
export class MatchExpression extends $node.Expression {
