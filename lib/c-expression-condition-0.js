...
face.IfExpression = class extends face.Expression {
...
face.PostIfExpression = class extends face.Expression {
    static patternsAndCaptures() {
        return [
...
face.MatchExpression = class extends face.Expression {
        ...
        if (this.items.value.length === 0) {
            ...
            let conditionPart = x =>
                $tools.instanceof(this.comparer, [
                    face.ArrowFunctionExpression,
                    face.DiamondFunctionExpression,
                    face.DashFunctionExpression
                ]) ?
