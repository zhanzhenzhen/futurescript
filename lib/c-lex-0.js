...
export class SyntaxError extends $lockedApi.SyntaxError {
    constructor(lexPart, message) {
        ...
        // in middle rounds of lex initialization, at which time lex will change. So
        // in that case we better use `rawPart` in test code. Test shouldn't check
        // middle round lex, otherwise the test code is confusing.
