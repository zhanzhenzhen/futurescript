...
"
`).toString();
assert(s === String.raw`VersionDirective "fus ${$api.currentVersion}", NormalToken "x", Colon, FormattedNormalString, PseudoCallLeftParenthesis, Str "abc\n    def-", Plus, NormalLeftParenthesis, NormalToken "a", NormalRightParenthesis, Plus, Str "-1", PseudoCallRightParenthesis`);
}); // ============================================================
...
"
`).toString();
assert(s === String.raw`VersionDirective "fus ${$api.currentVersion}", NormalToken "x", Colon, FormattedNormalString, PseudoCallLeftParenthesis, Str "abc\n    def-", Plus, NormalLeftParenthesis, NormalToken "a", NormalRightParenthesis, Plus, Str "\n    ccc-", Plus, NormalLeftParenthesis, NormalToken "b", NormalRightParenthesis, Plus, Str "    ddd", PseudoCallRightParenthesis`);
}); // ============================================================
