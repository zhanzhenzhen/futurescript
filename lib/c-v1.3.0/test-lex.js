...
_ as ..
`).toString();
assert(s === String.raw`VersionDirective "fus ${$api.currentVersion}", DotDot, Colon, NormalToken "_", Semicolon, DotDot, Colon, NormalToken "_", Semicolon, NormalToken "_", As, DotDot, Semicolon, NormalToken "_", As, DotDot`);
}); // ============================================================
