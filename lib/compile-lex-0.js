...
export class Lex {
    ...
    _round3() {
        ...
        this.value.forEach(token => {
            ...
            if (token instanceof LeftBrace || token instanceof Class) {
                inPropertyTable = true;
            }
            if (token instanceof RightBrace)
            if (
                token instanceof DashFunction ||
                token instanceof ArrowFunction ||
                token instanceof DiamondFunction
            ) {
...
class NormalToken extends Token {}
class VersionDirective extends Token {}
class Indent extends Token {}
class NormalLeftParenthesis extends Token {}
class CallLeftParenthesis extends Token {}
...
class Positive extends Token {}
class Negative extends Token {}
