    ...
    _round1(raw) {
        ...
        while (i < raw.length) {
            ...
            if (pendingToken instanceof VersionDirective) {
                ...
                if (char !== "\"") {
                    ...
                    if (char === interpolationChar && raw[i + 1] === "(") {
                        ...
                        if (
                            stringIndentValueRemaining !== null &&
                            stringIndentValueRemaining > 0 &&
                            (char === " " || char === "\t")
                        ) {
                            stringIndentValueRemaining--;
                        }
                        else {
                            if (char === "\r" || char === "\n") {
                                stringIndentValueRemaining = indentValue;
                            }
                            else {
                                stringIndentValueRemaining = null;
                            }
            ...
            if (pendingToken === null) {
                ...
                // double character as starting point
...
export class SingleLineNormalString extends Token {}
export class MultiLineNormalString extends Token {}
export class SingleLineVerbatimString extends Token {}
export class MultiLineVerbatimString extends Token {}
export class SingleLineRegex extends Token {}
export class MultiLineRegex extends Token {}
export class SingleLineJs extends Token {}
export class MultiLineJs extends Token {}
