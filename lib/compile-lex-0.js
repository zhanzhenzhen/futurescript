...
export class Lex {
    ...
    _round1(raw) {
        ...
        let stringType = null;
        let stringInterpolationChar = null;
        ...
        while (i < raw.length) {
            ...
            if (pendingToken instanceof VersionDirective) {
                ...
                if (char !== "\"") {
                    if (char === stringInterpolationChar && raw[i + 1] === "(") {
                        result.push(pendingToken);
            ...
            if (pendingToken === null) {
                ...
                // single character
                    ...
                    if (stringInterpolationChar !== null) {
                    ...
                    if (stringInterpolationChar !== null && stringInterpolationParenthesisLevel === 0) {
                        result.push(new Plus());
