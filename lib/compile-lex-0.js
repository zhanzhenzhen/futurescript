        ...
        while (i < raw.length) {
            ...
            if (pendingToken === null) {
                ...
                // single character as starting point
                    ...
                    result.push(new SmallNormalString());
...
export class SmallNormalString extends Token {}
export class BigNormalString extends Token {}
export class SmallVerbatimString extends Token {}
export class BigVerbatimString extends Token {}
export class SmallRegexString extends Token {}
export class BigRegexString extends Token {}
export class SmallJsString extends Token {}
export class BigJsString extends Token {}
